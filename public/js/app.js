...
function initGenealogy() {
  ...
  myDiagram = $(go.Diagram, "tree-diagram", // must be the ID or reference to div
  {
    "toolManager.hoverDelay": 100,
    // 100 milliseconds instead of the default 850
    allowCopy: false,
  ...
  var bluegrad = '#90CAF9';
  var pinkgrad = '#F48FB1'; // Set up a Part as a legend, and place it directly on the diagram
  ...
  var tooltiptemplate = $("ToolTip", {
    ...
    margin: 5
  }, new go.Binding("text", "", tooltipTextConverter))); // define Converters to be used for Bindings
  ...
  }, new go.Binding("text", "name"), $(go.Shape, "Rectangle", {
    fill: "lightgray",
    stroke: null,
    strokeWidth: 0,
    stretch: go.GraphObject.Fill,
    alignment: go.Spot.Center
  }, new go.Binding("fill", "gender", genderBrushConverter)), $(go.TextBlock, {
    font: "700 12px Droid Serif, sans-serif",
    textAlign: "center",
    margin: 10,
    maxSize: new go.Size(80, NaN)
  }, new go.Binding("text", "name"))); // define the Link template
...
__webpack_require__(/*! ../../public/js/tree-diagram */ "./public/js/tree-diagram.js");
...
__webpack_require__(/*! /home/user/Documents/php/demo/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/user/Documents/php/demo/resources/scss/main.scss */"./resources/scss/main.scss");
